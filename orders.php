...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if (in_array($newStatus, $allowedStatuses) && $purchaseId > 0) {
...
// Fetch orders data for orders tab
$rows = $pdo->query("
            ...
            <tbody>
                <?php foreach ($orders as $o): ?>
                    <tr>
                        ...
                        <td>
                            <div style="font-weight: 500;"><?= htmlspecialchars($o['customer']) ?></div>
                            <div style="font-size: 0.875rem; color: #666;"><?= htmlspecialchars($o['email']) ?></div>
                        </td>
                        <td>
                            <?php foreach ($o['items'] as $item): ?>
                                <div style="margin: 0.25rem 0; font-size: 0.875rem;">• <?= htmlspecialchars($item) ?></div>
                            <?php endforeach; ?>
                        </td>
                        ...
                        <td style="font-size: 0.875rem;">
                            <?= $o['date'] ?><br><small style="color: #6b7280;"><?= $o['time'] ?></small>
                        </td>
                        <td>
